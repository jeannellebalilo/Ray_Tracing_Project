...
public:
    ...
    void init(void){
        ...
        // Piazza @498
        // for-loop through the indices array, where triplet by triplet are the 3 indeces
        // pointing to 3 particular vertex and use that to read the position and normal
